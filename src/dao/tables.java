...
public class tables {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //st.executeUpdate("insert into appuser(userRole,name,mobileNumber,email,password,address,status) values('SuperAdmin','Super Admin','123','superadmin@testemail.com','admin','srilanaka','Active')");
            //st.executeUpdate("create table category(category_pk int AUTO_INCREMENT primary key,name varchar(200))");
            //st.executeUpdate("create table product(product_pk int AUTO_INCREMENT primary key,name varchar(200),quentity int,price int,description varchar(500),category_fk int)");
